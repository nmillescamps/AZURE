...
#########################
#Create File /etc/azure.txt contains User informations 
#########################
...
#########################
#Insert User informations in /etc/azure.txt
#########################
...
#########################
#Create the file /etc/license_type_id use for retrieve the license
#########################
...
#First Digit 1=premium 2=advanced 3=standard
#Second Digit 1 to 7 for users max
#########################
...
#########################
#Insert license number in the file /etc/license_type_id
#########################

echo $DIGIT1$DIGIT2 >$FILE_LICENSE

#########################
#Create the configuration file and active NIC eth1
#########################
...
#########################
#Create a symbolic link for use the command mail
#########################
ln -s /usr/sbin/sendmail.postfix /usr/sbin/sendmail

#########################
#send user informations by mail at mailgate.azure.subscription@axway.com
#########################

cat /etc/azure.txt | mail -s "Azure MarketPlace - New Mailgate Virtual Machine" mailgate.azure.subscription@axway.com

#########################
#reboot VM for activate NIC eth1 & file /etc/license_appliance_id
#########################
